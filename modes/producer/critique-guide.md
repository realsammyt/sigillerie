...
| **Aesthetic-Usability Effect** | Low craft triggers low trust in function before the user interacts. | Misaligned grid, inconsistent type scale, visible draft-mode quality in a shipped deliverable. |
